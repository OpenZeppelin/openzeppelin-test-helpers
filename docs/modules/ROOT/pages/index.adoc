...
NOTE: The following snippet uses https://github.com/OpenZeppelin/openzeppelin-test-environment[OpenZeppelin Test Environment]: a Truffle-based setup would work the same way.
